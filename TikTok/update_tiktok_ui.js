...
function handle_empty_slots(t, e) {
  const o = t.length,
    n = t[o - 1].element;
  function i(r) {
...
async function add_sorted_items_tiktok(t) {
  return new Promise((e) => {
    const o = t,
      n = document.querySelector('div[data-e2e="user-post-item-list"]');
    n || console.error("Original container not found.");
    const i = n.cloneNode(!1);
    o.forEach((r) => {
      const s = document.createElement("div");
      s.innerHTML = r.element;
      const d = s.firstElementChild;
      d && i.appendChild(d);
    }),
      handle_empty_slots(o, i),
      n.replaceWith(i),
      e(!0);
  });
}
function handle_header(t, e) {
  if (t === "views") return `Most Viewed ${e}`;
  if (t === "comments") return `Most Commented ${e}`;
  if (t === "likes") return `Most Liked ${e}`;
  if (t === "oldest") return `Oldest ${e}`;
  if (t === "shares") return `Most Shared ${e}`;
  if (t === "saves") return `Most Saved ${e}`;
}
function handle_sub_header(t, e, o, n) {
  if (o === "items") return `Latest ${t} ${e}`;
  if (o === "dates" && n === "1_week") return `${t} ${e} from 1 Week Back`;
  if (o === "dates" && n === "1_month") return `${t} ${e} from 1 Month Back`;
  if (o === "dates" && n === "3_month") return `${t} ${e} from 3 Months Back`;
  if (o === "dates" && n === "6_month") return `${t} ${e} from 6 Months Back`;
  if (o === "dates" && n === "1_year") return `${t} ${e} from 1 Year Back`;
  if (o === "dates" && n === "all_reels") return `${t} ${e}`;
}
function remove_default_banner() {
  const t = document.querySelector('[data-e2e="user-post-item-list"]');
  if (t) {
    ...
    if (e) {
      ...
      if (o) {
        ...
        for (const i of n) {
          if (i === e) break;
          i.tagName.toLowerCase() === "div" && o.removeChild(i);
        }
      }
    }
  }
}
function tiktok_tiktoks(t) {
  return t === 1 ? "TikTok" : "TikToks";
}
function add_banner(t, e, o, n, i) {
  const r = tiktok_tiktoks(e),
    s = handle_header(o, r),
    d = handle_sub_header(e, r, n, i),
    f = document.querySelector(
      '[data-e2e="user-post-item-list"]'
    )?.parentElement,
    a = document.createElement("div");
  (a.id = "banner_most_viewed_reels"),
    (a.style = `
    display: flex;
    align-items: center;
    ...
    margin-bottom: 0.2em;
  `),
    (a.className = "animate__animated animate__bounce"),
  ...
  `);
  const c = document.getElementById("reels_number_section"),
  ...
  const l = document.getElementById("export-native");
  l.addEventListener("mouseover", () => (l.style.opacity = "0.95")),
    l.addEventListener("mouseout", () => (l.style.opacity = "1")),
    document
...
function add_banner_v2(t, e, o, n, i) {
  let r = tiktok_tiktoks(e),
    s = handle_header(o, r),
    d = handle_sub_header(e, r, n, i);
  ...
  (a.id = "banner_most_viewed_reels"),
    ...
    `);
  let c = document.getElementById("export-btn-sort-reels");
  c.style = `
    margin-left: auto;
    background-color: white;
    color: #000;
    ...
    height: 2rem;
    `;
  let m = document.getElementById("reels_number_section"),
    l = document.createElement("img"),
    g = chrome.runtime.getURL("Icons/128 Sort Feed.png");
  (l.src = g),
    (l.style = `width: 0.7rem;
    position: 1rem;
    position: relative;
    top: -0.01rem;
    margin-right: 0.2rem;
  ...
  function h() {
    let u = document.getElementById("export-btn-sort-reels");
    u.style = `
      margin-left: auto;
  ...
  c.addEventListener("mouseover", h, !1),
    c.addEventListener("mouseout", y, !1),
    c.addEventListener("click", function () {
      chrome.runtime.sendMessage({ export_click_tiktok: !0, sorted_data: t });
    });
}
function remove_unneeded_elements() {
  document.querySelector('div[data-e2e="user-post-item-list"]').replaceWith(""),
    document.getElementById("export-btn-sort-reels").replaceWith("");
}
function add_overlay() {
  const t = document.getElementsByTagName("body")[0];
  let e = document.createElement("div");
  (e.id = "overlay_sort_reels"),
    (e.style = `
  position: fixed;
  display: block;
  width: 100%;
  ...
  cursor: pointer;
  `),
    (e.class = "animate__animated animate__zoomIn"),
    t.append(e);
}
window.addEventListener("message", (t) => {
  if (t.source === window) {
    if (t.data.logo_animate_off_tiktok) {
      let e = t.data.payload;
      add_sorted_items_tiktok(e).then(() => {
        let o = e.length,
        ...
        window.scrollTo({ top: 0, behavior: "smooth" }),
          add_banner(e, o, n, r, s),
          remove_items_local_storage_tiktok(),
          chrome.runtime.sendMessage({ logo_animate_off: !0 });
      });
    } else if (t.data.logo_animate_off_zero_tiktok_time_period) {
      let e = null,
        o = sessionStorage.getItem("sortFeedSortBy"),
        n = 0,
        i = sessionStorage.getItem("sortItemsVsDates"),
        r = sessionStorage.getItem("sortFeedNoItems");
      window.scrollTo({ top: 0, behavior: "smooth" }),
        add_banner(e, n, o, i, r),
        remove_unneeded_elements(),
        remove_items_local_storage_tiktok(),
        chrome.runtime.sendMessage({ logo_animate_off: !0 });
    } else if (t.data.overlay_on)
      add_overlay(), chrome.runtime.sendMessage({ logo_animate_on: !0 });
    else if (t.data.item_collected_no) {
      let e = t.data.number_items;
      chrome.runtime.sendMessage({ item_collected_no: !0, number_items: e });
    }
  }
});
